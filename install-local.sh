...
sed -i.bak -e "s|Icon=/opt/firefox/chrome/icons/default/default128.png|Icon=$HOME/firefox/chrome/icons/default/default128.png|" $HOME/.local/share/applications/firefox.desktop
rm ~/firefox*.tar.*
rm ~/install-local.sh
echo "Done."